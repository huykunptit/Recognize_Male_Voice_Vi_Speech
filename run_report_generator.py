...
# -*- coding: utf-8 -*-
"""
Script khởi động Algorithm Report Generator
"""
...
def generate_report():
    """Tạo báo cáo"""
    print("Tao bao cao hieu suat cac thuat toan...")
    print("=" * 60)
    
    try:
        from generate_algorithm_report import main
        main()
        ...
        print(f"ERROR - Loi tao bao cao: {e}")
...
def main():
    ...
    print("- Tao bao cao chi tiet voi bieu do")
    print("- Phan tich diem manh/yeu cua tung thuat toan")
    print("- Xep hang va khuyen nghi")
    print("=" * 60)
